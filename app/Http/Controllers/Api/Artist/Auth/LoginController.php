...
class LoginController extends Controller
{
    ...
    */
    ...
    public function login(Request $request)
    {
        ...
        $user->token = $user->createToken('api_artist')->accessToken; 

        //this function return only specific column values
        $result = $user->only(['id','name', 'country_code', 'email', 'mobile', 'fb_id', 'insta_id', 'created_at', 'signature_image', 'profile_image', 'background_image', 'award_achievement', 'other_content', 'referral_code']);
    ...
    public function logout(Request $request)
    {
        ...
        // Delete token
        $request->user('api_artist')->token()->revoke();
