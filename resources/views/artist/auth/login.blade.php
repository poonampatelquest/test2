        ...
        <div class="col-md-6">
          <div class="login-inner-box">
              <div class="login-inner main-login">
                  ...
                  <form  class="form-wrapper" class="form-wrapper" method="POST" action="{{ route('artist.login') }}" id="validate">
                    @csrf
                     <div class="inner-form-box">
                      ...
                      <div class="form-group">
                        ...
                        <a href="{{ route('artist.forget.password.show') }}" class="forgot-link">Forgot Password?</a>
                      </div>
                      @error('password')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
