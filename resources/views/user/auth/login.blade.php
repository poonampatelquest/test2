        ...
        <div class="col-md-6">
          <div class="login-inner-box">
              <div class="login-inner main-login">
                  <h2>User Login</h2>
                  <h6>Login to your account to start the service</h6>
                   @if (session('status'))
                  ...
                  <form  class="form-wrapper" class="form-wrapper" method="POST" action="{{ route('login') }}" id="validate">
                    @csrf
                     <div class="inner-form-box">
                      ...
                      <div class="form-group">
                        <input type="password" class="form-control"  placeholder="Password*" name="password" id="password" data-rule-required="true" data-msg-required="Please enter password.">
                        <a href="{{ route('forget.password.show') }}" class="forgot-link">Forgot Password?</a>
                      </div>
                      @error('password')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                      ...
                      <div class="text-center">
                         <button class="common-btn-new login-btn" type="submit">&nbsp;  Login  &nbsp;</button>

                         <div class="not-an-acount">
                           Dont have an Account?  <a href="{{ route('register') }}">Signup</a>
                         </div>
                      </div>
                     </div>
                  </form>
